...
2. Press Tab to indent (requires custom input rules - not yet implemented)
3. Or manually adjust structure through the ProseMirror API

<Note>
Nested list handling and Tab key support are planned features. Check the TODOs in the source code for implementation status.
</Note>
